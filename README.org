...
* This is my personal configuration. This is not meant as a plug and play configuration. :noexport:
...
- [[https://github.com/xmonad/xmonadcontrib][Xmonadcontrib]] 
*** Xmonad-log
- [[https://hackage.haskell.org/package/dbus][haskelldbus]]
** Polybar
